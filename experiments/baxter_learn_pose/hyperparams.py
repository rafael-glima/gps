...
from gps.agent.ros_baxter.agent_baxter import AgentBaxter
...
common = {
    ...
    # Are these initial conditions?... unclear... will want to set these to some higher number (4?)
    'conditions': 1,
}
...
agent = {
    ...
    # A few initial body configurations... these are what the conditions number is matching
